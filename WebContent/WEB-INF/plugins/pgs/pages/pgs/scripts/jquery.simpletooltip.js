...
;(function($){
	...
	$.fn.simpletooltip = function(settings) {
		...
		this.each(function () {
			...
			if (options.keyup) {
				$(this).bind("keyup", {"options": options, "target": this}, openTooltip);
			}
	...
	function getTooltip(target) {
		...
		*/
		var $tooltip = $('<div>',{
						 'html': '<div class="contenu-infobulle"><p><strong>' + $(target).data('title') + '</strong><br></p><br><p>' + $(target).attr('alt')+'</p></div>',
						 'id': "infobulle"
						 });
	...
	function openTooltip(e){
		...
		$target.bind("blur", function(){
			...
			$target.unbind("blur");
			$target.unbind("keyup");
			$target.bind("keyup", {"options": opts, "target": $target}, openTooltip);
		});
