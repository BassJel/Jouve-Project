...
import com.doculibre.constellio.solr.handler.cluster.carrot2.CarrotClusteringEngine;
 ...
 *
 */
public class ConstellioClusteringComponent extends SearchComponent implements SolrCoreAware {
  private transient static Logger log = LoggerFactory.getLogger(ConstellioClusteringComponent.class);
