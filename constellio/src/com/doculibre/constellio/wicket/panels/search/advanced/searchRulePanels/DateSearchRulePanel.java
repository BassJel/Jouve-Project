...
public class DateSearchRulePanel extends AbstractNumericSearchRulePanel<DateSearchRule> {

	public DateSearchRulePanel(String id, SimpleSearch search, DateSearchRule rule, IModel typesModel) {
