...
public class DoubleSearchRule extends AbstractNumericSearchRule<Double> {

	public static final String TYPE = "double";

	public DoubleSearchRule() {
		super();
	}

	public DoubleSearchRule(SimpleParams params, SearchRulesGroup parent, String lookupPrefix) {
		super(params, parent, lookupPrefix);
	}

	@Override
	protected Double fromHTTPParam(String param) {
