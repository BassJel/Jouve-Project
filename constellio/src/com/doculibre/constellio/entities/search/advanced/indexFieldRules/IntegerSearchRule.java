...
public class IntegerSearchRule extends AbstractNumericSearchRule<Integer> {

	public static final String TYPE = "int";

	public IntegerSearchRule() {
		super();
	}

	public IntegerSearchRule(SimpleParams params, SearchRulesGroup parent, String lookupPrefix) {
		super(params, parent, lookupPrefix);
	}

	@Override
	protected Integer fromHTTPParam(String param) {
