...
public class RecordCollection extends ConstellioLabelledEntity {
    ...
    private String instanceDirName;
    ...
    public String getInstanceDirName() {
		return instanceDirName;
	}

	public void setInstanceDirName(String instanceDirName) {
		this.instanceDirName = instanceDirName;
	}
	
	@Transient
	public String getEffectiveInstanceDirName() {
		return StringUtils.isNotBlank(instanceDirName) ? instanceDirName : name;
	}
