...
public class FeedContentImpl implements FeedContent {
	...
	public FeedContentImpl(String value) throws ParseFeedException {
		this(value, BASE64BINARY);
	}

	public FeedContentImpl(String value, String encoding) throws ParseFeedException {
		if (StringUtils.isBlank(value)) {
			throw new ParseFeedException("Blank value");
		}
		this.value = value;
