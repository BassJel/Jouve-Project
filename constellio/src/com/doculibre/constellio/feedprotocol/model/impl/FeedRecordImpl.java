...
public class FeedRecordImpl implements FeedRecord {
	...
	public FeedRecordImpl(String datasource, String feedtype, String groupActionStr, String url, String action, String mimetype, String lastModified, String lock, String authmethod, List<FeedContent> contents, List<FeedMetadata> metadatas) throws ParseFeedException {		
		...
		if (lastModified != null) {
			...
			try {
				...
				try {
					...
					throw new ParseFeedException("Cannot parse last-modified with ISO 8601 OR RFC822 date format: " + lastModified);
				}
			}
