...
public class LongSearchRulePanel extends AbstractNumericSearchRulePanel<LongSearchRule> {

	public LongSearchRulePanel(String id, SimpleSearch search, LongSearchRule rule, IModel typesModel) {
