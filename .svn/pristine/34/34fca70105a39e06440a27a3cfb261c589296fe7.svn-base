...
public class SimpleSearch implements Serializable, Cloneable {
    ...
    private List<Long> selectedResults = new ArrayList<Long>();
    ...
    public String getEscapedQuery() {
        ...
        if (query != null && !SEARCH_ALL.equals(query)) {
            ...
            // FIXME
//            QueryParser queryParser = new QueryParser(Version.LUCENE_44, IndexField.DEFAULT_SEARCH_FIELD,
//                new FrenchAnalyzer(Version.LUCENE_44));
//            try {
...
//			String clusterLabel = searchableFacet.getPossibleValuesLabels().get(value).get(this.locale);
    ...
    public SimpleSearch clone() {
        ...
        clone.selectedResults = new ArrayList<Long>(selectedResults);
	...
	public SimpleParams toSimpleParams(boolean onlyAdvancedSearchRuleTypes) {
	    ...
	    if (selectedResults != null && !selectedResults.isEmpty()) {
	        params.add("selectedResults", StringUtils.join(selectedResults, ","));
	    }
	    return params;
	}
...
//		}
	...
	public static SimpleSearch toSimpleSearch(SimpleParams params) {
	    ...
	    String selectedResults = params.getString("selectedResults");
	    if (selectedResults != null) {
	    	simpleSearch.selectedResults = new ArrayList<Long>();
	    	for(String selectedResult : selectedResults.split(",")) {
	    		simpleSearch.selectedResults.add(Long.valueOf(selectedResult));
	    	}
	    }
	...
	public List<Long> getSelectedResults() {
