...
public class DoubleSearchRulePanel extends AbstractNumericSearchRulePanel<DoubleSearchRule> {

	public DoubleSearchRulePanel(String id, SimpleSearch search,
			DoubleSearchRule rule, IModel typesModel) {
		super(id, search, rule, typesModel);
	}

	@Override
	protected String getSearchRuleType() {
		return DoubleSearchRule.TYPE;
	}
