...
public class GsaFeedConnection implements FeedConnection {
  ...
  public synchronized void setFeedHostAndPort(String host, int port)
    ...
    URL contextPathURL = WebappUtils.getContextPathURL();
    feedUrl = new URL(contextPathURL + "/xmlfeed");
    dtdUrl = new URL(contextPathURL + "/getdtd");
    contentEncodings = null;
    backlogUrl = new URL(contextPathURL + "/getbacklogcount");
    lastBacklogCheck = 0L;
  }
