 ...
 */
public final class FrenchAccentPlurielAnalyzer extends StopwordAnalyzerBase {
   ...
   *          a stopword set
   */
  public FrenchAccentPlurielAnalyzer(Version matchVersion, CharArraySet stopwords){
