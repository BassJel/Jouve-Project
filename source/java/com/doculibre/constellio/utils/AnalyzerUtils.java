...
//        return sb.toString();
    ...
    public static Analyzer getDefaultAnalyzer(boolean useStopWords) {
        Analyzer analyzer;
        if (useStopWords) {
            analyzer = new FrenchAccentPlurielAnalyzer(Version.LUCENE_44);
        } else {
        	CharArraySet emptyStpWords = new CharArraySet(Version.LUCENE_44,new HashSet<String>(),true);
            analyzer = new FrenchAccentPlurielAnalyzer(Version.LUCENE_44, emptyStpWords);
        }
//        if (useStopWords) {
//            analyzer = new FrenchAccentAnalyzer(Version.LUCENE_44);
//        } else {
//            Set<String> emptyStpWords = new HashSet<String>();
//            analyzer = new FrenchAccentAnalyzer(Version.LUCENE_44, emptyStpWords);
//        }
        return analyzer;
    }
