...
public class SkosIndexHelperImpl extends BaseLuceneIndexHelper<SkosConcept> implements SkosIndexHelper {
    ...
    protected Field[] createIndexFields() {
        ...
        fields.add(new StringField(ID, "", Field.Store.YES));
        fields.add(new StringField(THESAURUS_ID, "", Field.Store.YES));
    ...
    public void add(Thesaurus thesaurus) {
        ...
        try {
            ...
            IndexWriter indexWriter = new IndexWriter(directory,  new IndexWriterConfig(Version.LUCENE_44, analyzer));
