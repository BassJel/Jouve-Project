...
public class FloatSearchRulePanel extends AbstractNumericSearchRulePanel<FloatSearchRule> {

	public FloatSearchRulePanel(String id, SimpleSearch search,
			FloatSearchRule rule, IModel typesModel) {
