...
@Entity
public class CollectionFederation extends BaseConstellioEntity {

    private RecordCollection ownerCollection;
    
    private RecordCollection includedCollection;
    ...
    @ManyToOne
    public RecordCollection getIncludedCollection() {
        return includedCollection;
    }

    public void setIncludedCollection(RecordCollection includedCollection) {
