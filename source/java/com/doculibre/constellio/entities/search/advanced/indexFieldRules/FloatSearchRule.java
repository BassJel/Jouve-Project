...
public class FloatSearchRule extends AbstractNumericSearchRule<Float> {

	public static final String TYPE = "float";

	public FloatSearchRule() {
		super();
	}

	public FloatSearchRule(SimpleParams params, SearchRulesGroup parent, String lookupPrefix) {
		super(params, parent, lookupPrefix);
	}

	@Override
	protected Float fromHTTPParam(String param) {
